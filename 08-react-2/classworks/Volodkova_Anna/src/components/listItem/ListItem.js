...
function ListItem (props) {
    return (
      <div className="card">
        <div className="whoWhen"> Posted by {props.li.data.author} {moment.unix(props.li.data.created_utc).startOf('day').fromNow()} </div>
        ...
        <div className="comments">
          ...
          {props.li.data.num_comments} Comments</div>
      </div>
    );
}
