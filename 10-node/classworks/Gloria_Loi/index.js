...
const HASH =
  '37e753db1079f7d8ff8d145769664df46b12d8c3a3c4930a2e66ab76a8bfb4ca9e0fe69b7bc40355755846342cf19c95c58fa538d964963f04aff409621ec330';
const SALT = 'salt';
...
const server = http.createServer((req, res) => {
  ...
  if (req.method === 'POST') {
    ...
    req.on('end', () => {
      const key = crypto
        .pbkdf2Sync(qs.parse(body).password, SALT, ITERATIONS, KEYLEN, DIGEST)
        .toString('hex');
      res.write(`${key === HASH}`);
      res.end();
    });
